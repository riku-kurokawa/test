...
frame_interval, dpi, file_name = int(waveL*dx/C/dt), 100, "pre2"
...
#animate1d(u_field[:,:int(nx/2)] / np.max(u_field[:,:int(nx/2)]), frame_interval, dpi, file_name)
#vectorAni(u_field[:,:int(nx/2)] / np.max(u_field[:,:int(nx/2)]), 0.5 * v_field[:,:int(nx/2)] / np.max(v_field[:,:int(nx/2)]), 5, frame_interval, dpi, file_name + "v")
#densityAni(u_field[:,:int(nx/2)] * 20, frame_interval, dpi, file_name)
#vectorAni(u_field[:,:int(nx/2)] / np.max(u_field[:,:int(nx/2)]), 2* a_field[:,:int(nx/2)] / np.max(a_field[:,:int(nx/2)]), 5, frame_interval, dpi, file_name + "a")
